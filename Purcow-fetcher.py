...
import asyncio
import requests
API_URL = "https://api.btc6x.com"
API2_URL = 'https://api.purcow.io/v1/public'
API_SYMBOLS = "/api/default/ticker"
API_SNAPSHOT = '/book?pair='
WSS_URL = "wss://socket.btc6x.com/socket.io/?EIO=3&transport=websocket"
SUB_TIMEOUT = 0.001
REST_TIMEOUT = 0.1
PING_TIMEOUT = 24
SNAPSHOT_TIMEOUT = 1
